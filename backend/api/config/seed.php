...
$artistesData = [
    // index 0 — ARTISTE DU MOIS
    [
        'nom'             => 'Mofor',
        'prenom'          => 'Marielina',
        'pays'            => 'Cameroun',
        'bio'             => 'Photographe camerounaise reconnue, Marielina Mofor capture l\'âme des villes et la poésie du quotidien avec un regard unique.',
        'specialite'      => 'Photographie',
        'photo_url'       => '',
        'artiste_du_mois' => true,
    ...
    [
        ...
        'prenom'          => 'Amira',
        'pays'            => 'Maroc',
        'bio'             => 'Aquarelliste marocaine, Amira El Fassi puise son inspiration dans l\'architecture et les motifs géométriques de Fès et Marrakech.',
...
$oeuvresData = [
    // Marielina Mofor — Photographie (index 0)
    [
    ...
    // Isabelle Moreau — Peinture (index 1)
    [
    ...
    // Yuki Nakamura — Sculpture (index 2)
    [
    ...
    // Amira El Fassi — Aquarelle (index 3)
    [
...
$artistes->createIndex(['artiste_du_mois' => 1]);
